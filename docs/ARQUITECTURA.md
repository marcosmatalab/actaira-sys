...
<!--cifra:pares-->101<!--/cifra-->, y <!--historica-->205<!--/historica--> pruebas con <!--cifra:pruebas-->564<!--/cifra-->. Lo que hacía daño no era cada número, sino que la frase convertía
...
**<!--cifra:pruebas-->564<!--/cifra--> pruebas de Python** y **<!--cifra:pruebas_go-->102<!--/cifra--> de Go**).
