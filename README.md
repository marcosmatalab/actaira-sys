...
| Pruebas | <!--cifra:pruebas-->564<!--/cifra--> de Python + <!--cifra:pruebas_go-->102<!--/cifra--> de Go |
| Fases de la puerta de aceptación | <!--cifra:fases_de_la_puerta-->26<!--/cifra--> |
| Defectos de las pasadas adversariales | <!--cifra:defectos_adversariales-->142<!--/cifra-->, cada uno con su nombre en `docs/BACKLOG.md` |
...
- **Las pasadas adversariales.** Cada fase cierra con una antes de abrir la
  ...
  lección. <!--cifra:defectos_adversariales-->142<!--/cifra--> hasta hoy. Los más
